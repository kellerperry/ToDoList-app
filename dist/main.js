...
class Task {
    constructor(name, dueDate = (0,_today__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date())) {
        this.name = name;
    ...
    setDueDate(date) {
        this.dueDate = (0,_today__WEBPACK_IMPORTED_MODULE_0__["default"])(date);
    }
...
function today(date) {
    if((0,date_fns__WEBPACK_IMPORTED_MODULE_0__.isToday)(date)) {
        ...
        const newDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.format)(date, 'MMM d');
        return newDate;
    }
}
...
const trash = new _Task__WEBPACK_IMPORTED_MODULE_0__["default"]("take out trash");

console.log(trash.dueDate)

const homework = new _Task__WEBPACK_IMPORTED_MODULE_0__["default"]("do homework");
